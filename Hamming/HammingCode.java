...
public class HammingCode {
    public static void main(String args[]) {
        ...
        System.out.println("сколько битов:");
        int n = scan.nextInt();
        int a[] = new int[n];

        for(int i=0 ; i < n ; i++) {
            System.out.println("Бит N-. " + (n-i) + ":");
        ...
        System.out.println();
        System.out.println("Введите положение бита для изменения, чтобы проверить обнаружение ошибки на стороне приемника (0 для отсутствия ошибки):");
